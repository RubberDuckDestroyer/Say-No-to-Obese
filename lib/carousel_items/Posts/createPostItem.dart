...
class CreatePostItem extends CarouselItem {
  CreatePostItem(String title, String subtitle, String imageUrl,
      String description, LoginController conn)
      : super(title, subtitle, imageUrl, description, MOTIVATION.toString(),
            conn);
}
